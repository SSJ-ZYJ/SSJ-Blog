...
<!-- search panel -->
<div id="search-panel" class="float-panel float-panel-closed search-panel fixed lg:absolute z-50
left-4 right-4 md:left-auto md:right-4 md:w-[30rem]
top-20 shadow-2xl rounded-2xl p-2">
    ...
    {#each result as item}
       ...
       rounded-xl text-lg px-3 py-2 hover:bg-[var(--btn-plain-bg-hover)] active:bg-[var(--btn-plain-bg-active)]">
            <div class="transition text-90 inline-flex font-bold group-hover:text-[var(--primary)]">
                {item.meta.title}<svg xmlns="http://www.w3.org/2000/svg" class="transition text-[0.75rem] translate-x-1 my-auto text-[var(--primary)]" width="0.75em" height="0.75em" viewBox="0 0 320 512"><path fill="currentColor" d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256L73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
            </div>
